...
export const ProfilePostImageData = [
    require("../storage/images/dino-1.jpg"), require("../storage/images/dino-2.jpg"),
    require("../storage/images/dino-3.jpg"), require("../storage/images/dino-4.jpg"),
    require("../storage/images/dino-5.jpg"), require("../storage/images/dino-6.jpg")
]

export const whatsappNumber = "+6287824142475"